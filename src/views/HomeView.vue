  ...
  <div class="wrapper wrapper-forcontent">
    ...
    <div class="content-without-footer">
      ...
      <main>
        ...
        <!--Секция фото-галерея-->
        <figure class="foto-block-home">
          <h3 class="direct-discription">Живые эмоции</h3>
          <h2 class="direct-title">Наша <span class="direct-title-el">фото-галерея</span></h2>
        ...
        <figure class="link-social">
          ...
          <SocialLink class="link-social-wrp" />
        </figure>
      </main>
    </div>

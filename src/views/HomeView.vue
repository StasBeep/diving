    ...
    <div class="content-without-footer">
      ...
      <header class="header">
        ...
        <div class="header-info">
          ...
          <div class="heaedr-info-details">
            <span class="heaedr-info-details-text">Работаем с 2009 года</span>
            <span class="heaedr-info-details-text">Более 2500 учеников</span>
          </div>
        </div>
        <ol class="heaedr-cards">
          <li class="heaedr-cards-li">
            <span class="heaedr-cards-li-title">
            ...
            <p class="heaedr-cards-li-text">Акции и горячие предложения на курсы обучения.</p>
            <router-link class="heaedr-cards-li-router" to="#">Узнать больше</router-link>
          </li>
          <li class="heaedr-cards-li">
            <span class="heaedr-cards-li-title">
              <svg width="20" height="19" viewBox="0 0 20 19">
            ...
            <p class="heaedr-cards-li-text">Оставьте свой вопрос, мы перезвоним и проконсультируем вас.</p>
            <router-link class="heaedr-cards-li-router" to="#">Оставить вопрос</router-link>
          </li>
          <li class="heaedr-cards-li">
            <span class="heaedr-cards-li-title">
              <svg width="20" height="19" viewBox="0 0 20 19">
            ...
            <p class="heaedr-cards-li-text">Дайвинг в подарок для ваших друзей и знакомых.</p>
            <router-link class="heaedr-cards-li-router" to="#">Приобрести</router-link>
          </li>
        </ol>
      </header>
